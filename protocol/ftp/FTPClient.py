...
class BaseFTPClient(object):
        ...
        for _ in range(retries):
            try:
                self.ftp_client.connect(
                    self.ftp_target, self.ftp_port, timeout=FTP_TIMEOUT)
                return True
    ...
    def login(self, username: str, password: str) -> bool:
        ...
        try:
            ...
            print_success(
                self.peer,
                "FTP Authentication Successful, Username: {}, Password: {}".format(
                    username,
                    password),
                verbose=self.verbosity)
            return True
    ...
    def get_content(self, remote_file: str) -> str:
        ...
        try:
            ...
            self.ftp_client.retrbinary(
                "RET: {}".format(remote_file), content.write)
