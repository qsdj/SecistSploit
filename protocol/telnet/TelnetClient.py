...
class BaseTelnetClient(object):
    ...
    def connect(self) -> bool:
        ...
        try:
            ...
            print_error(self.peer, "Telnet Error while connecting to the server", error_code, verbose=self.verbosity)
        return False
    ...
    def login(self, username: str, password: str, retries: int=1) -> bool:
        ...
        for _ in range(retries):
            try:
                ...
                print_error(self.peer, "Telnet Error while authenticating to the server", error_code, verbose=self.verbosity)
        return False
    ...
    def test_connect(self) -> bool:
        ...
        try:
            ...
            print_error(self.peer, "Telnet Error while testing connection to the server", error_code, verbose=self.verbosity)
        return False
    ...
    def read_until(self, data: bytes) -> bytes:
        ...
        try:
            ...
            print_error(self.peer, "Telnet Error while reading data from the server", error_code, verbose=self.verbosity)
        return None
    ...
    def write(self, data: bytes) -> bool:
        ...
        try:
            ...
            print_error(self.peer, "Telnet Error while writing to the server", error_code, verbose=self.verbosity)
        return False
    ...
    def close(self) -> bool:
        ...
        try:
            ...
            print_error(self.peer, "Telnet Error while closing connection", error_code, verbose=self.verbosity)
        return False
...
class TelnetClient(Exploit):
    ...
    def telnet_create(self, target: str=None, port: int=None) -> BaseTelnetClient:
        ...
        telnet_client = BaseTelnetClient(telnet_target, telnet_port, verbosity=self.verbosity)
